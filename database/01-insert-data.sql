INSERT INTO Event (event_name, event_venue, prefix) VALUES
  ('ICT Event Tuguegarao', CONCAT('Cagayan State University', CHAR(10),'July 8 (Thursday)'), 'Cagayan24'),
  ('ICT Event Cauayan', CONCAT('Isabela State University', CHAR(10) ,'July 9 (Friday)'), 'Isabela24');
...
INSERT INTO Booths (topic, presentor, event_id, email, logo, password) VALUES
  ...
  ('EVES', 'EVES', 1, "eves1", "assets/logo/eves.png", "$2y$10$Asat.QOp9MkktqGANZ0vxOoDvWFVX2jwuLGpbwUSCTtg9rPWU4Sdi"),
  ('Phoenix Virtual Solutions', 'Phoenix Virtual Solutions', 1, "phoenix1", "assets/logo/pheonix.jpg", "$2y$10$qxD.0DbS/b2fRRI9drmlzeUU.WZ.5ihig6YEgPCzlQZkh20udp9tm"),
  ...
  ('EVES', 'EVES', 2, "eves2", "assets/logo/eves.png", "$2y$10$Asat.QOp9MkktqGANZ0vxOoDvWFVX2jwuLGpbwUSCTtg9rPWU4Sdi"),
  ('Phoenix Virtual Solutions', 'Phoenix Virtual Solutions', 2, "phoenix2", "assets/logo/pheonix.jpg", "$2y$10$qxD.0DbS/b2fRRI9drmlzeUU.WZ.5ihig6YEgPCzlQZkh20udp9tm");
